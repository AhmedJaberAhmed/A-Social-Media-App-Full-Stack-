...
class _PostTileState extends State<PostTile> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _heartAnimation = Tween<double>(begin: 0.8, end: 1.6).animate(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // POST IMAGE WITH DOUBLE TAP AND HEART
          GestureDetector(
            onDoubleTap: () {
              final isAlreadyLiked = widget.post.likes.contains(currentUser!.uid);
              if (!isAlreadyLiked) {
                toggleLikePost(); // 👍 only like if not liked
              }
