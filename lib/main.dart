...
import 'package:instagram/themes/themCubit/theme_cubit.dart';
...
import 'features/search/data/search_repo_imp.dart';
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<AuthCubit>(
          create: (context) =>
          AuthCubit(authRepo: AuthRepoImp())
            ..checkAuth(),
        ),
        ...
        BlocProvider<SearchCubit>(
            create: (context) => SearchCubit(searchRepo: SearchRepoImp())),
